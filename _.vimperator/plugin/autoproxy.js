// Via: http://marlonyao.iteye.com/blog/776775
// only set string value
function setPreferenceValue(branch, name, value) {
    var prefs = Components.classes["@mozilla.org/preferences-service;1"].getService(Components.interfaces.nsIPrefService).getBranch(branch);
    var str = Components.classes["@mozilla.org/supports-string;1"].createInstance(Components.interfaces.nsISupportsString);
    //var prefs = Components.classes["@autoproxy.org/aup/startup;1"].getService(Components.interfaces.nsIPrefService).getBranch(branch);
    //var str = Components.classes["@mozilla.org/supports-string;1"].createInstance(Components.interfaces.nsISupportsString);
    str.data = value;
